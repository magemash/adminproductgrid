...
//        $this->setUseAjax(true);
        ...
        $id = Mage::registry('id');
        $this->id = $id;
        $this->customGrid = $this->helper->getGrid($id);
        $this->fields = $this->customGrid->getFields($id);
    }
    ...
    protected function _prepareCollection()
    {
        ...
        foreach ($this->fields as $field) {
            if ($field->getTableName() == 'attribute') {
                $collection
                    ->addAttributeToSelect($field->getField());
            }
        }
    ...
    protected function _prepareColumns()
    {
        ...
        foreach ($fields as $field) {
            ...
            if ($field->getType() == 'options') {
                $row['options'] = $field->getTypeOptions($field->getField());
            }

            $rows[] = $row;

            $this->addColumn($field->getField(), $row);
        }
